      ...
      <header className="flex items-center justify-between px-6 py-4 max-w-7xl mx-auto">
        <div className="flex items-center space-x-8">
          ...
          <nav className="hidden md:flex items-center space-x-6 text-sm text-gray-600">
            <a href="#" className="hover:text-gray-900">Начать</a>
            <a href="#" className="hover:text-gray-900">Продукты</a>
            <a href="#" className="hover:text-gray-900">Решения</a>
            <a href="#" className="hover:text-gray-900">Сравнение</a>
            <a href="#" className="hover:text-gray-900">Цены</a>
            <a href="#" className="hover:text-gray-900">Вопросы</a>
          </nav>
        </div>
      ...
      <section className="py-16 px-6">
        <div className="max-w-4xl mx-auto">
          <div className="flex items-center justify-center space-x-12 opacity-60">
            ...
            <div className="text-lg font-bold border-b-2 border-black pb-1">Запуск</div>
      ...
      <section className="py-16 px-6 text-center">
        <div className="max-w-2xl mx-auto">
          <div className="w-16 h-16 rounded-full bg-gray-200 mx-auto mb-6 overflow-hidden">
            <img src="/professional-headshot.png" alt="Отзыв" className="w-full h-full object-cover" />
          </div>
          <h3 className="text-xl font-semibold mb-4">Быстрая и простая настройка</h3>
          <p className="text-gray-600 mb-2">
            "Мы масштабировались до тысяч заметок ежедневно. Панель управления
            приложения — единственное, что помогает нам оставаться в здравом уме."
          </p>
          <p className="text-sm text-gray-500">Михаил из НотоПлан, официальный представитель</p>
        </div>
      </section>
      ...
      <section className="py-16 px-6 bg-gray-50">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-gray-600 mb-12">
            От заметки до страницы и организованной жизни — сосредоточьтесь на росте.
          </p>

          <div className="flex flex-wrap justify-center gap-4 mb-8">
            <Button variant="outline" className="rounded-full bg-transparent">Магазин</Button>
            <Button variant="outline" className="rounded-full bg-transparent">Оформление</Button>
            <Button className="bg-black text-white rounded-full">Почта</Button>
            <Button variant="outline" className="rounded-full bg-transparent">Рассылка</Button>
            <Button variant="outline" className="rounded-full bg-transparent">Сканер</Button>
          </div>
        </div>
      </section>
            ...
            <div className="w-80 h-96 bg-gray-100 rounded-2xl p-4 shadow-lg">
              <div className="bg-white rounded-xl h-full p-4 flex flex-col">
                ...
                <div className="bg-gray-50 rounded-lg p-3 mb-3">
                  <div className="text-sm font-semibold mb-1">Новая заметка</div>
                  <div className="text-xs text-gray-500">Сегодня, 9:19</div>
                </div>
                <div className="bg-gray-50 rounded-lg p-3 flex-1">
                  <div className="text-lg font-bold mb-2">организовано</div>
                  <div className="text-sm mb-2">Ваш проект с Михаилом уже в приложении!</div>
                  <div className="flex items-center space-x-2">
                    <div className="w-8 h-8 bg-pink-200 rounded-full"></div>
                    <div className="text-xs">Создайте первую заметку и организуйте</div>
                  </div>
                </div>
              </div>
            </div>
